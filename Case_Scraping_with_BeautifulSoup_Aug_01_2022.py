...
with open('case_scraping_Aug_01_2022.csv', mode='w') as case_file:
...
def process_ten_cases(main_url, idx):
    ...
    with open('case_scraping_Aug_01_2022.csv', mode='a') as case_file: #append mode
        case_writer = csv.writer(case_file, delimiter=',',  quotechar='"', quoting=csv.QUOTE_MINIMAL)
