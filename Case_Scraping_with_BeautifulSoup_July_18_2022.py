...
label_row = ['bverfg_id_forward', 'date_and_first_docket', 'docket_numbers', 'senate_and_chamber', 'participating_judges', 'decision_date', 'short_description' , 'decision', 'full_text']


with open('case_scraping_July_18_2022.csv', mode='w') as case_file:
...
def process_ten_cases(main_url, idx):
    ...
    with open('case_scraping_July_18_2022.csv', mode='a') as case_file: #append mode
        case_writer = csv.writer(case_file, delimiter=',',  quotechar='"', quoting=csv.QUOTE_MINIMAL)
